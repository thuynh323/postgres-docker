...
COPY clicks FROM '/data/clicks.csv' DELIMITER ',' CSV HEADER;
COPY leads FROM '/data/leads.csv' DELIMITER ',' CSV HEADER;
COPY rate_tables FROM '/data/rate_tables.csv' DELIMITER ',' CSV HEADER;

CREATE ROLE replicator REPLICATION LOGIN PASSWORD '123456';
CREATE PUBLICATION ppub FOR ALL TABLES;
